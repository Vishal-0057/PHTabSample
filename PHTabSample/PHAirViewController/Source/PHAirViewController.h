...
@interface PHAirViewController : UIViewController <PHAirMenuDelegate, PHAirMenuDataSource, UIGestureRecognizerDelegate, UIAlertViewDelegate>
...
@property (nonatomic, strong) NSString *PHSegueRootIdentifier;
